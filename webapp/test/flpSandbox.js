		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Prova",
									"targetURL": "#zsapcubeoneprova-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsapcubeoneprova-display": {
								"semanticObject": "zsapcubeoneprova",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsap.cubeone.prova",
									"url": sap.ui.require.toUrl("zsap/cubeone/prova")
								}
							}
						}
					}
